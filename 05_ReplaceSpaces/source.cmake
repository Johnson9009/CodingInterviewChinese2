...
set(05_REPLACESPACES_SRCS ${05_REPLACESPACES_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/ReplaceSpaces.cpp
)
...
add_executable(05_ReplaceSpaces ${05_REPLACESPACES_SRCS})
...
target_compile_features(05_ReplaceSpaces PRIVATE cxx_std_11)
