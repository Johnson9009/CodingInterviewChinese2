...
set(21_REORDERARRAY_SRCS ${21_REORDERARRAY_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/ReorderArray.cpp
)
...
add_executable(21_ReorderArray ${21_REORDERARRAY_SRCS})
...
target_compile_features(21_ReorderArray PRIVATE cxx_std_11)
