...
bool IsSymmetrical(BinaryTreeNode const* root1, BinaryTreeNode const* root2) {
  if ((root1 == nullptr) && (root2 == nullptr)) return true;
  if (((root1 == nullptr) || (root2 == nullptr)) || (root1->m_nValue != root2->m_nValue)) {
    return false;
  }
...
bool IsSymmetrical(BinaryTreeNode const* root) {
  if (root == nullptr) return true;
  return IsSymmetrical(root->m_pLeft, root->m_pRight);
}

// ====================测试代码====================
void Test(char const* testName, BinaryTreeNode* pRoot, bool expected) {
