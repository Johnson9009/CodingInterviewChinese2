...
set(29_PRINTMATRIX_SRCS ${29_PRINTMATRIX_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/PrintMatrix.cpp
)
...
add_executable(29_PrintMatrix ${29_PRINTMATRIX_SRCS})
...
target_compile_features(29_PrintMatrix PRIVATE cxx_std_11)
