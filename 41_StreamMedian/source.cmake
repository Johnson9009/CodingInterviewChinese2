...
set(41_STREAMMEDIAN_SRCS ${41_STREAMMEDIAN_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/StreamMedian.cpp
)
...
add_executable(41_StreamMedian ${41_STREAMMEDIAN_SRCS})
...
target_compile_features(41_StreamMedian PRIVATE cxx_std_11)
