...
set(51_INVERSEPAIRS_SRCS ${51_INVERSEPAIRS_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/InversePairs.cpp
)
...
add_executable(51_InversePairs ${51_INVERSEPAIRS_SRCS})
...
target_compile_features(51_InversePairs PRIVATE cxx_std_11)
