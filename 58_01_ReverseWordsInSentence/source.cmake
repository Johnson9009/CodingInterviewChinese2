...
set(58_01_REVERSEWORDSINSENTENCE_SRCS ${58_01_REVERSEWORDSINSENTENCE_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/ReverseWordsInSentence.cpp
    ${CMAKE_HOME_DIRECTORY}/Utilities/StringUtil.cpp
)
...
add_executable(58_01_ReverseWordsInSentence ${58_01_REVERSEWORDSINSENTENCE_SRCS})
...
target_compile_features(58_01_ReverseWordsInSentence PRIVATE cxx_std_11)
