...
set(60_DICESPROBABILITY_SRCS ${60_DICESPROBABILITY_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/DicesProbability.cpp
)
...
add_executable(60_DicesProbability ${60_DICESPROBABILITY_SRCS})
...
target_compile_features(60_DicesProbability PRIVATE cxx_std_11)
