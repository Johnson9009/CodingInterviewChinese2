...
set(64_ACCUMULATE_SRCS ${64_ACCUMULATE_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/Accumulate.cpp
)
...
add_executable(64_Accumulate ${64_ACCUMULATE_SRCS})
...
target_compile_features(64_Accumulate PRIVATE cxx_std_11)
